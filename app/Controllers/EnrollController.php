...
class EnrollController extends AbstractController{
    ...
    protected function makeModel() : Model{
        ...
        return new EnrollModel(DB_USER,DB_PASSWORD,DB_NAME,DB_HOST);
    }
